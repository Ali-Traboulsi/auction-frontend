...
const AuctionCancelPage = () => {
  ...
  const fetchAllAuctionData = useCallback(
    (pageNumber) => {
      ...
      fetch(
        `${process.env.API_BASE_URL}/api/user/all/rejected-auction?name=${searchProduct}&page=${pageNumber}`,
        requestOptions
      )
  ...
  const title = "Cancelled Auctions";
...
export default AuctionCancelPage;
