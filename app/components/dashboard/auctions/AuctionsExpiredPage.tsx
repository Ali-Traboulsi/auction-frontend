...
const AuctionsExpiredPage = () => {
  ...
  const fetchAllAuctionData = useCallback(
    (pageNumber) => {
      ...
      fetch(
        `${process.env.API_BASE_URL}/api/user/all/expired-auction?name=${searchProduct}&page=${pageNumber}`,
        requestOptions
      )
...
export default AuctionsExpiredPage;
