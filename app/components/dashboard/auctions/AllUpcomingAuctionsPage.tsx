...
const AllUpcomingAuctionsPage = () => {
  ...
  const fetchAllAuctionData = useCallback(
    (pageNumber) => {
      ...
      fetch(
        `${process.env.API_BASE_URL}/api/user/all/upcoming-auction?name=${searchProduct}&page=${pageNumber}`,
        requestOptions
      )
  ...
  const title = "Upcomming Auctions";
...
export default AllUpcomingAuctionsPage;
