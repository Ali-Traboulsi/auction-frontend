...
export default function BlogSmCard({ data }) {
  return (
    <div className="flex gap-[12px] group">
      <div className="overflow-hidden flex-grow-1 w-[80px] rounded-[4px]">
        {data?.photo && (
          <Image
            width={80}
            height={80}
            alt="blog imag"
            src={data?.photo}
            className="group-hover:scale-105 transition-all rounded-[4px]"
          />
        )}
      </div>
      <div className="w-[calc(100%-102px)]">
        <h4 className="mb-[8px] text-[20px]">
          <Link
            className="group-hover:text-auc-primary-color"
        ...
        <div className="flex gap-[8px]">
          <svg
            ...
            fill="none"
          >
            <g clipPath="url(#clip0_2575_19107)">
              <path
            ...
            <defs>
              <clipPath id="clip0_2575_19107">
                <rect width="18" height="18" fill="white" />
              </clipPath>
            </defs>
          </svg>
          <span className="text-[12px] font-normal leading-[170%]">
            {data.updated_created_at}
          </span>
        </div>
      </div>
    </div>
